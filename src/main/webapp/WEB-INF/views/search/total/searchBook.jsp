                ...
                <ul class="pagination d-flex justify-content-center gap-4 fw-bold">
                  ...
                  <c:if test="${bookList.beginPage != 1}">
                    <li class="${bookList.currentPage == 1 ? 'disabled' : ''}">
                      <a class="px-2 py-1" href="?keyword=${keyword}&page=${bookList.currentPage - 1}"
                        ${bookList.currentPage==1 ? 'onclick="return false;"' : '' }>Previous</a>
                    </li>
                  </c:if>
                  <!-- 동적 페이지 번호 버튼 -->
                  ...
                  <li class="${bookList.currentPage == bookList.totalPage ? 'disabled' : ''}">
                    <a class="px-2 py-1" href="?keyword=${keyword}&page=${bookList.currentPage + 1}"
                      ${bookList.currentPage==bookList.totalPage ? 'onclick="return false;"' : '' }>Next</a>
                  </li>
                </ul>
              </div>
            </c:if>
