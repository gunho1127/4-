    ...
    <body>
      ...
      <div id="wrapper" class="py-3">
        ...
        <div class="container py-5 px-0 overflow-hidden size">
          <section class="post">
            <div class="post_sch pb-3 border-bottom d-flex justify-content-between search">
              <!-- 총 검색 결과 -->
              ...
              <div>
                <form method="get" action="/search/total/post" class="d-inline">
                  ...
                  <button class="btn-filter ${sort == 'popular' ? 'active' : ''} " type="submit">
                    인기순
                  </button>
                </form>
                <form method="get" action="/search/total/post" class="d-inline">
                  ...
                  <!-- 검색어 유지 -->
                  <input type="hidden" name="keyword" value="${keyword}" />
                  <button class="btn-filter ${sort == 'recent' ? 'active' : ''} me-3" type="submit">
                    최신순
                  </button>
                </form>
              </div>
