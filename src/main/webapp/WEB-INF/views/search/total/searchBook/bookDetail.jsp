          ...
          <article class="bs_images pt-5 pb-4 border-bottom border-black">
            ...
            <div class="text-center" style="background: var(--color-f2f4f8)">
              ...
              <button id="toggleButton" type="button"
                style="background: none; border: none; color: var(--color-blue); cursor: pointer;">
                상세 이미지 더보기 &or;
              </button>
            </div>
          </article>
          ...
          <article class="bs_review py-5 px-3 border-bottom border-black" id="bs_review">
            ...
            <form action="/review" method="post" class="d-flex align-items-center">
              ...
              <div class="flex-grow-1 mx-3">
                <textarea class="form-control" name="reviewContent" placeholder="리뷰를 작성해주세요" style="
                  height: 100px;
                  border: none;
              ...
              <div style="height: 100px">
                <button class="rounded-3 h-100 px-4" style="
                        ...
                        <div class="col text-end">
                          ...
                          <form action="/deleteReview" method="post" style="display:inline;">
                            ...
                            <button type="submit" style="border: none; background: none;">
                              <img src="/resources/images/search/bs_icon1.jpg" alt="삭제" title="삭제"
                                style="width: 16px;" />
                            </button>
                          </form>
                          <!-- 좋아요 아이콘 -->
                          <form action="/likeReview" method="post" style="display:inline;">
                            <input type="hidden" name="reviewId" value="${review.id}" />
                            <button type="submit" style="border: none; background: none;">
                              <img src="/resources/images/search/bs_icon2.jpg" alt="좋아요" title="좋아요"
                                style="width: 16px;" />
                            </button>
