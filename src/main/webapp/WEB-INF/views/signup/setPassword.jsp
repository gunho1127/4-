                        ...
                        <div class="login-box">
                            ...
                            <form id="password-form" class="w-100" method="post" action="/signup/setPassword">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="id" value="${sessionScope.id}" readonly
                                        disabled>
                                </div>
                                ...
                                <div class="mb-3 input-container">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <!-- 클리어 아이콘 -->
                                        <span id="clear-icon"
                                            class="clear-icon position-absolute top-50 end-0 translate-middle-y">
                                            <img src="../../../resources/images/signup/open-eye-icon.png" alt="보기 아이콘" id = "toggle-password"
                                                class="open-eye-img">
                                            <!-- <img src="../../../resources/images/signup/clear-icon.png" alt="지우기 아이콘"
                                    ...
                                    <!-- 오류 메시지 -->
                                    <span id="password-error" class="text-danger mt-2"></span>
                                </div>
                                ...
                                <div class="mb-3 input-container">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <!-- 클리어 아이콘 -->
                                        <span id="clear-icon-confirm" 
                                            class="clear-icon position-absolute top-50 end-0 translate-middle-y">
                                            <img src="../../../resources/images/signup/clear-icon.png"
                                                alt="Clear Input">
                                        </span>
                                        <!-- 비밀번호 보이기/숨기기 아이콘 -->

                                    </div>
                                    <span id="confirm-password-error" class="text-danger mt-2"></span>
                                </div>
