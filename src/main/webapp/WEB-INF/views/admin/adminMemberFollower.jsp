...
<head>
  ...
  <link rel="stylesheet" href="../../../resources/css/admin/adminMemberFollower.css">
      ...
      <div class="page-content">
        ...
        <div class="dashboard-tabs">
          <div class="tabs">
            ...
            <div class="tab">
              <div class="text-container">
                <div class="tab-text2">팔로잉</div>
              </div>
            </div>
            <div class="tab2">
              <div class="text-container">
                <div class="tab-text3">팔로워</div>
              </div>
            </div>
          </div>
